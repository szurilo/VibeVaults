/**
 * Main Responsibility:
 * LinkedIn brand glyph as an inline SVG. Replaces lucide-react's `Linkedin`,
 * which is deprecated upstream (all brand icons are due for removal in v1.0).
 * Path data from Simple Icons (CC0).
 *
 * Sensitive Dependencies:
 * None — pure presentational SVG. Inherits color via `currentColor`.
 */
