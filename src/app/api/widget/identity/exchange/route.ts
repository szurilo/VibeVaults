 ...
 * as a Bearer credential on subsequent widget API calls. (Guests never hit
 * this route: the hosted /review/[token] page mints their identity via the
 * redeemReviewLink server action and redirects with `?vv_token=` + `?vv_key=`.)
 *
