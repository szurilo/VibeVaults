  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="px-4 md:px-8 py-4 flex justify-between items-center max-w-7xl mx-auto w-full">
          ...
          <nav className="hidden md:flex gap-8 flex-1 justify-center">
            <Link
              href="#features"
              className="text-sm font-semibold text-gray-600 hover:text-primary transition-all duration-200"
            >
              Features
            </Link>
            <Link
          ...
          <div className="flex gap-2 md:gap-4 items-center flex-1 justify-end">
            <Link
              href="/auth/login"
              className="text-sm font-semibold px-3 py-2 md:px-4 text-gray-700 hover:text-gray-900 transition-colors whitespace-nowrap"
            >
              Sign In
            </Link>
            <Link
      ...
      <main className="flex-1 flex flex-col items-center">
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "The feedback tool for modern agencies. Collect visual feedback, share progress with clients, and ship faster with VibeVaults.",
              offers: {
                "@type": "AggregateOffer",
                lowPrice: "29.00",
                highPrice: "149.00",
        ...
        <section className="flex flex-col items-center justify-center py-20 px-4 text-center max-w-7xl mx-auto">
          <div className="max-w-4xl">
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-none mb-8 text-gray-900">
              Ship client sites faster without the{" "}
            ...
            <p className="text-xl md:text-2xl text-gray-500 max-w-3xl mb-12 leading-relaxed mx-auto">
              Clients comment right on the live site. No logins, no browser
              extensions, and you never pay per client. Send a link, they start
              marking up, you ship faster.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
              <Link
                href="/auth/register"
                className="inline-flex items-center justify-center px-10 py-4 rounded-full font-bold text-lg transition-all duration-300 bg-secondary text-white hover:bg-secondary/90 hover:shadow-2xl hover:-translate-y-1 active:translate-y-0"
              >
                Claim your founding member spot
              </Link>
              <Link
                href="#demo"
                className="inline-flex items-center justify-center px-10 py-4 rounded-full font-bold text-lg transition-all duration-300 border-2 border-gray-200 text-gray-700 hover:border-primary hover:text-primary hover:shadow-lg hover:-translate-y-1 active:translate-y-0"
              >
                See it in action
              </Link>
            </div>
        ...
        <div id="demo">
          <ProductDemo videoUrl="https://www.youtube-nocookie.com/embed/Zeaf79Idd-U?rel=0&modestbranding=1&autoplay=1&mute=1&playsinline=1&loop=1&playlist=Zeaf79Idd-U" />
        </div>
        ...
        <section
          id="pricing"
          className="py-32 w-full flex flex-col items-center bg-gray-50"
        >
