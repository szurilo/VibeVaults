...
- **Session context captured with each report** (`getMetadata()` in `public/widget.js`): page URL, UA, screen/viewport, language, plus two buffers rendered in the feedback detail sheet:
